...
public class RenderMaskTest : MonoBehaviour
{
	...
	void OnEnable()
	{
		originModeFlag = Wave.XR.Utils.InputSubsystem.GetTrackingOriginMode();
        Wave.XR.Utils.InputSubsystem.TrySetTrackingOriginMode(TrackingOriginModeFlags.Device);
	}
	...
	{
        Wave.XR.Utils.InputSubsystem.TrySetTrackingOriginMode(originModeFlag);
