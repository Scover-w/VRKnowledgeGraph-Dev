...
public static class GraphConfigurationTools
{
    ...
    public static GraphConfigValueType GetConfigValueType(this GraphConfigKey key)
    {
        return key switch
        {
            ...
            GraphConfigKey.AlphaNodePropagated => GraphConfigValueType.Float,
            GraphConfigKey.AlphaNodeUnPropagated => GraphConfigValueType.Float,
            GraphConfigKey.AlphaEdgePropagated => GraphConfigValueType.Float,
            GraphConfigKey.AlphaEdgeUnPropagated => GraphConfigValueType.Float,
            ...
            GraphConfigKey.LuminosityOntologyColor => GraphConfigValueType.Float,
    ...
    private static Type GetRealType(this GraphConfigKey key)
    {
        return key switch
        {
            ...
            GraphConfigKey.AlphaNodePropagated => typeof(float),
            GraphConfigKey.AlphaNodeUnPropagated => typeof(float),
            GraphConfigKey.AlphaEdgePropagated => typeof(float),
            GraphConfigKey.AlphaEdgeUnPropagated => typeof(float),
            ...
            GraphConfigKey.LuminosityOntologyColor => typeof(float),
    ...
    private static float GetFloatValue(this GraphConfigKey key, GraphConfiguration graphConfig)
    {
        return key switch
        {
            ...
            GraphConfigKey.AlphaNodePropagated => graphConfig.AlphaNodePropagated,
            GraphConfigKey.AlphaNodeUnPropagated => graphConfig.AlphaNodeUnPropagated,
            GraphConfigKey.AlphaEdgePropagated => graphConfig.AlphaEdgePropagated,
            GraphConfigKey.AlphaEdgeUnPropagated => graphConfig.AlphaEdgeUnPropagated,
            ...
            GraphConfigKey.LuminosityOntologyColor => graphConfig.LuminosityOntologyColor,
